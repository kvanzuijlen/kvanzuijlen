...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) [`43.120.2`](https://github.com/renovatebot/renovate/releases/tag/43.120.2) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [jenkinsci/helm-charts](https://github.com/jenkinsci/helm-charts) [`jenkins-5.9.14`](https://github.com/jenkinsci/helm-charts/releases/tag/jenkins-5.9.14) - Jenkins helm charts
...
- [redpanda-data/helm-charts](https://github.com/redpanda-data/helm-charts) [`connect-3.2.1`](https://github.com/redpanda-data/helm-charts/releases/tag/connect-3.2.1) - Redpanda Helm Chart
