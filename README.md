...
- [oauth2-proxy/oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) [`v7.10.0`](https://github.com/oauth2-proxy/oauth2-proxy/releases/tag/v7.10.0) - A reverse proxy that provides authentication with Google, Azure, OpenID Connect and many more identity providers.
