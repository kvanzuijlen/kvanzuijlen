...
- [robinebers/openusage](https://github.com/robinebers/openusage) [`v0.7.0-beta.9`](https://github.com/robinebers/openusage/releases/tag/v0.7.0-beta.9) - Burning through your subscriptions too fast? Paying for stuff you never use? Stop guessing. OpenUsage is free and open source.
- [renovatebot/renovate](https://github.com/renovatebot/renovate) [`43.232.0`](https://github.com/renovatebot/renovate/releases/tag/43.232.0) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [kvanzuijlen/octoprint-bambu](https://github.com/kvanzuijlen/octoprint-bambu) [`v1.11.7-82`](https://github.com/kvanzuijlen/octoprint-bambu/releases/tag/v1.11.7-82) - 
